...
CREATE TABLE product_category (
  ...
  CONSTRAINT fk_prodcat_parent FOREIGN KEY (parent_product_category_id) REFERENCES product_category (product_category_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--
-- Table structure for table review_rating_type
--
...
--
-- Dumping data for table review_rating_type
--
