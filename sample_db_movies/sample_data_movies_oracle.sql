--Script to create and populate the movie database
...
--
--Data for this table loaded in using CSV
...
CREATE TABLE movie (
  ...
  homepage varchar2(1000) DEFAULT NULL,
  overview varchar2(1000) DEFAULT NULL,
  popularity NUMBER(12,6) DEFAULT NULL,
  release_date date DEFAULT NULL,
  revenue NUMBER(20) DEFAULT NULL,
  runtime NUMBER(5) DEFAULT NULL,
  movie_status varchar2(50) DEFAULT NULL,
  tagline varchar2(1000) DEFAULT NULL,
  vote_average NUMBER(4,2) DEFAULT NULL,
  vote_count NUMBER(10) DEFAULT NULL,
...
CREATE TABLE movie_cast (
  ...
  cast_order NUMBER(5) DEFAULT NULL,
...
CREATE TABLE movie_keywords (
  movie_id NUMBER(10) DEFAULT NULL,
  keyword_id NUMBER(10) DEFAULT NULL,
...
CREATE TABLE movie_languages (
  movie_id NUMBER(10) DEFAULT NULL,
  language_id NUMBER(10) DEFAULT NULL,
  language_role_id NUMBER(10) DEFAULT NULL,
